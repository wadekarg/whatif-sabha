...
async def generate_orchestrator_message(
    ...
    event_instructions = {
        ...
        "closing_summary": (
            f"The debate is ending now. Keep your closing SHORT — a few short paragraphs, 5-8 sentences total. Not an essay.\n\n"
            ...
            f"- Notable unresolved: {'; '.join(context.get('unresolved_details', ['none']))[:200]}\n\n"
            f"Structure — three short paragraphs, roughly equal length:\n"
            f"  Paragraph 1 (2-3 sentences): the heart of the debate. Name the fiercest clash, quote a phrase if you can. What was the real fault line?\n"
            f"  Paragraph 2 (2-3 sentences): the tally, in your voice. State how many disputes were resolved and how many questions got answers — but phrase it with your wit, not as a balance sheet. If something important was left unresolved, name it briefly.\n"
            f"  Paragraph 3 (1-2 sentences): the verdict + sendoff. What truth emerged or what lie was exposed? Close with warmth and edge.\n\n"
            ...
            f"Vary from prior closings.\n\n"
            f"Right register examples (each is 3 short paragraphs):\n"
            f"  'Napoleon and Boxer burned hottest tonight — a pig and a workhorse arguing "
            f"  about whose back breaks first. Neither yielded.\\n\\n"
            f"  Of eight disputes, you settled five. Of twelve questions, nine got answers "
            f"  — not all honest, but answers. What's left is the one neither of you would "
            f"  touch: who decides when the silos are empty.\\n\\n"
            f"  The revolution doesn't die from whips. It dies from bellies no one counted. "
            f"  Sleep on that, all of you. The Sabha rests.'\n\n"
            f"5-8 sentences total across three short paragraphs. Stop there."
        ),
        "observer_intro": (
