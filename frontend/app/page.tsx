      ...
      <footer className="bg-[#faf7f2] border-t border-[#e8e0d5] py-3.5 px-6">
        <div className="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-x-6 gap-y-2 text-xs text-[#a09282]">
          <span className="flex items-center gap-3">
            ...
            <span className="hidden md:inline italic text-[#c8b89a]">what if things had gone differently?</span>
          </span>
          <span className="flex items-center gap-4">
            <a href="https://github.com/wadekarg/whatif-sabha" target="_blank" rel="noopener noreferrer" className="hover:text-[#c07820] transition-colors" title="GitHub" aria-label="GitHub">
            ...
            <a href="https://www.linkedin.com/in/gajananwadekar/" target="_blank" rel="noopener noreferrer" className="hover:text-[#c07820] transition-colors" title="LinkedIn" aria-label="LinkedIn">
